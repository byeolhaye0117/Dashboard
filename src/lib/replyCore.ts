...
export const FACILITIES = ["주차 가능","샤워실","락커","운동복 대여","사우나","24시간 운영",
...
export function promptFacts(kind, o, place, extra){
  o = o || {};
  place = place || {};
  extra = extra || {};
