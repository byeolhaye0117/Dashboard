 ...
 * 「문의」는 예약보다 앞이다
 *
 * 값만 묻고 끊은 전화, 이름도 안 남기고 간 방문 — 아직 아무것도 잡히지 않은
 * 건이다. 이런 것을 「예약」으로 넣으면 잡히지도 않은 약속이 예약 수에 섞인다.
 * 결론이 난 것은 아니므로 등록·미등록과 달리 진행중으로 센다.
 */
export const STAGES = ["문의", "예약", "약속전환", "등록", "미등록"] as const;
